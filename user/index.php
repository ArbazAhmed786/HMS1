...
<html lang="en">
  ...
  <body style="background-color:">
    ...
    <div class="container-fluid">
      ...
      <li><a href="index.php?page=dashboard"> <span class="glyphicon glyphicon-user">&nbsp;</span>DashBoard</a></li>
			<li><a href="index.php?page=update_password"><span class="glyphicon glyphicon-user"></span> Update Password</a></li>
            <li><a href="index.php?page=update_profile"><span class="glyphicon glyphicon-user"></span> my Profile</a></li>
			 <li><a href="index.php?page=notification"><span class="glyphicon glyphicon-envelope"></span> Notification</a></li>
       <li><a href="index.php?page=hostel_booking"><span class="glyphicon glyphicon-envelope"></span> Hostel_Booking</a></li>
       <li><a href="index.php?page=room-details"><span class="glyphicon glyphicon-envelope"></span>Hostel details</a></li>
      ...
      if($page=="hostel_booking")
			{
				include('hostel_booking.php');
			
			}
      if($page=="room-details")
			{
				include('room-details.php');
