...
if($r==true)
{
    $sql1 = "insert into admin values('','$name','$aid','$pass','$an','$email')";
                    ...
                    <div class="panel-body">
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="aid" type="text" autofocus required placeholder="Admin_id">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="pass" type="password" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="an" type="number" autofocus required placeholder="Number">
                                </div>
